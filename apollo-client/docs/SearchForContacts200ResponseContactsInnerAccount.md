...
# SearchForContacts200ResponseContactsInnerAccount
...
```typescript
import type { SearchForContacts200ResponseContactsInnerAccount } from ''
...
const example = {
  ...
  "creatorId": null,
  "ownerId": 66302798d03b9601c7934ec2,
  ...
  "crmRecordUrl": https://samplecrm.pipedrive.com/organization/7,
} satisfies SearchForContacts200ResponseContactsInnerAccount
...
const exampleParsed = JSON.parse(exampleJSON) as SearchForContacts200ResponseContactsInnerAccount
