...
# ViewDeal200ResponseOpportunity
...
```typescript
import type { ViewDeal200ResponseOpportunity } from ''
...
const example = {
  ...
  "numContacts": 0,
  "account": null,
} satisfies ViewDeal200ResponseOpportunity
...
const exampleParsed = JSON.parse(exampleJSON) as ViewDeal200ResponseOpportunity
