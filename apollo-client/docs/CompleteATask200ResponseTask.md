...
```typescript
import type { CompleteATask200ResponseTask } from ''
...
} satisfies CompleteATask200ResponseTask
...
const exampleParsed = JSON.parse(exampleJSON) as CompleteATask200ResponseTask
