...
`accounts` | [Array&lt;SearchForAccounts200ResponseAccountsInner&gt;](SearchForAccounts200ResponseAccountsInner.md)
`numFetchResult` | any

## Example

```typescript
import type { SearchForAccounts200Response } from ''
...
const example = {
  ...
  "accounts": null,
  "numFetchResult": null,
} satisfies SearchForAccounts200Response
...
const exampleParsed = JSON.parse(exampleJSON) as SearchForAccounts200Response
