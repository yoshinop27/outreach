...
# UpdateDeal200ResponseOpportunity
...
```typescript
import type { UpdateDeal200ResponseOpportunity } from ''
...
const example = {
  ...
  "stageUpdatedAt": 2024-09-10T21:31:53.640+00:00,
  "nextStepLastUpdatedAt": null,
  "exchangeRateCode": USD,
  "exchangeRateValue": 1,
  "amountInTeamCurrency": 999999999999,
  "forecastedRevenue": 249999999999.75,
  "lastActivityDate": 2024-09-10T21:30:04.809Z,
  "existenceLevel": full,
  "typedCustomFields": null,
  "opportunityRuleConfigStatuses": null,
  "opportunityContactRoles": null,
  "currency": null,
} satisfies UpdateDeal200ResponseOpportunity
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateDeal200ResponseOpportunity
