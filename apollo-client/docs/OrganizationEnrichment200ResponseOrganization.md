...
# OrganizationEnrichment200ResponseOrganization
...
`accountId` | string
`account` | [OrganizationEnrichment200ResponseOrganizationAccount](OrganizationEnrichment200ResponseOrganizationAccount.md)
...
```typescript
import type { OrganizationEnrichment200ResponseOrganization } from ''
...
} satisfies OrganizationEnrichment200ResponseOrganization
...
const exampleParsed = JSON.parse(exampleJSON) as OrganizationEnrichment200ResponseOrganization
