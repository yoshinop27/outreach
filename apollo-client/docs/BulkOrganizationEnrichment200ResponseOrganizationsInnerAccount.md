...
# BulkOrganizationEnrichment200ResponseOrganizationsInnerAccount
...
```typescript
import type { BulkOrganizationEnrichment200ResponseOrganizationsInnerAccount } from ''
...
} satisfies BulkOrganizationEnrichment200ResponseOrganizationsInnerAccount
...
const exampleParsed = JSON.parse(exampleJSON) as BulkOrganizationEnrichment200ResponseOrganizationsInnerAccount
