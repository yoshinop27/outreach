...
# UpdateAContact200ResponseContact
...
```typescript
import type { UpdateAContact200ResponseContact } from ''
...
} satisfies UpdateAContact200ResponseContact
...
const exampleParsed = JSON.parse(exampleJSON) as UpdateAContact200ResponseContact
