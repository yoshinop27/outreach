...
```typescript
import type { CreateATask200ResponseTask } from ''
...
const example = {
  ...
  "opportunity": null,
} satisfies CreateATask200ResponseTask
...
const exampleParsed = JSON.parse(exampleJSON) as CreateATask200ResponseTask
